...
function legendClickCallback(s) {
    for (var a = (s = s || window.event).target || s.srcElement; "LI" !== a.nodeName; )
        a = a.parentElement;
...
$(document).ready(function() {
    ...
    if (!c) {
        (C = $(".sidenav-toggler")).on("click", function() {
            1 == u ? ($("html").removeClass("nav_open"),
            C.removeClass("toggled"),
            u = 0) : ($("html").addClass("nav_open"),
            C.addClass("toggled"),
            u = 1)
        }),
        c = !0
    ...
    if (!h) {
        ...
        C.on("click", function() {
            1 == u ? ($("html").removeClass("quick_sidebar_open"),
            $(".quick-sidebar-overlay").remove(),
            C.removeClass("toggled"),
            h = 0) : ($("html").addClass("quick_sidebar_open"),
            C.addClass("toggled"),
    ...
    if (!d) {
        ...
        k.on("click", function() {
            1 == m ? ($("html").removeClass("topbar_open"),
            k.removeClass("toggled"),
            m = 0) : ($("html").addClass("topbar_open"),
            k.addClass("toggled"),
            m = 1)
        }),
        d = !0
